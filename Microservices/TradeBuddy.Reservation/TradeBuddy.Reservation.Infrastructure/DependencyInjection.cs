...
using TradeBuddy.Reservation.Application.Common.Interfaces;
using TradeBuddy.Reservation.Infrastructure.Messaging;

namespace TradeBuddy.Payment.Infrastructure
{
